    ...
    for lvl in levels:
        ...
        <div class="max-w-6xl mx-auto px-6 py-24">
            <header class="mb-20">
                ...
                <h1 class="text-7xl font-black tracking-tighter italic text-slate-900 leading-none">The N5 <span class="text-indigo-600 underline">Collection.</span></h1>
            </header>
            ...
            async function loadHub() {{
                ...
                g.innerHTML = d.kanji_set.map(k => `
                    <div class="glass-card p-10 rounded-[3rem] text-center flex flex-col items-center border border-slate-100">
                        ...
                        <a href="/{lvl}/kanji/${{k.slug}}.html" class="w-full py-4 bg-slate-900 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-indigo-600 transition-all">View More</a>
                    </div>
                `).join('');
            }}
